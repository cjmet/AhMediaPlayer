...
{
    public static class CommonAdvancedSearch
    {
        ...
        {
            throw new Exception("This method is permanently depreciated and as been replaced by a similar function in DataLibrary");
